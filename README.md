...
## Overview
Based on the data released by the American Heart Association, in 2020 there were 928,741 deaths caused by cardiovascular and a total cost of $407.3 billion. Therefore, The Behavioral Risk Factor Surveillance System (BRFSS) United States, they were surveyed each individual about the behavior that potentially to cardiovascular disease. Their goal is to give preventive services to people who have potential cardiovascular disease. So, I created a machine learning to predict. Does someone have the potential for cardiovascular or not. So The BRFSS United States could give preventive services right on target and reduce the costs of CVD. At the end of the result, the performance of the model is not good, there is overfitting on the precision metric but good on the recall metric with a score of 0.78. Since the precision is lower than recall, it means that the BRFSS United States needs more effort to filter which one is the true positive CVD. On the simulation of a model, if there are 100 people with CVD the total mean direct medical care costs for patients with established cardiovascular disease (CVD) was 18,953 US dollars per patient per year. The model caught 78 people, and we could save $1.5 million in costs.
